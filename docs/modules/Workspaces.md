...
| `format_named`   | `string`                                    | `"{label}"` | The format string for named workspaces. Supports `{label}`, `{name}`, and `{index}`.                                                                                      |
| `format_unnamed` | `string`                                    | `"{label}"` | The format string for unnamed workspaces. Supports `{label}`, `{name}`, and `{index}`.                                                                                    |
